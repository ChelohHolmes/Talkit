...
$query = "INSERT INTO public.usuario (id_usuario, nombres, apellidos, fecha_nac, correo, sexo, username, lengua_mater, contrasena, foto_perfil, intereses, votos, puntos, verificado, estado, entrada, salida, volumen, idioma) VALUES (DEFAULT, '" . $data["Name"] . "', '" . $data["LastName"] . "', '" . $data["Birthday"] . "', '" . $data["Email"] . "', '" . $data["Gender"] . "', '" . $data["User"] . "', '" . $data["NativeLanguage"] . "', '" . $data["Password"] . "', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, '" . $data["NativeLanguage"] . "')";
